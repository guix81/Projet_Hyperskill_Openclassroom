...
guix = User('guix', 'abab')
thread = guix.make_thread('Fucking', "je t'ai cassé!")
post = guix.post(thread, "pas touche à mon oseille")
thread.display()
mod = Moderator("gogo", 'rtrt')
mod.delete(thread, post)
thread.display()
file = File('coco.txt', '20 octets')
post1 = guix.post(thread, "yourou!!!!", file)
thread.display()
